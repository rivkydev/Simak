...
@php
$idKelurahan = Auth::guard('pegawai')->user()?->id_kelurahan ?? 1;

$menus = [
['icon' => 'monitoring', 'label' => 'Dashboard', 'route' => route('admin.dashboard'), 'active' => Route::is('admin.dashboard')],
['icon' => 'home_work', 'label' => 'Profil Kelurahan', 'route' => route('admin.profil', ['id_kelurahan' => $idKelurahan]), 'active' => Route::is('admin.profil')],
['icon' => 'draft_orders', 'label' => 'Pelayanan Surat', 'route' => route('admin.pelayanan'), 'active' => Route::is('admin.pelayanan')],
['icon' => 'store', 'label' => 'Data UMKM', 'route' => route('admin.umkm'), 'active' => Route::is('admin.umkm')],
];
@endphp
