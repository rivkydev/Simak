...
<div class="bg-[#CBDCEB] w-full">
    <div class="px-4 md:px-8 py-10 max-w-4xl mx-auto text-[#0A142F] font-semibold">
        ...
        <h1 class="text-3xl font-bold mb-2">Surat Keterangan Domisili Usaha</h1>
        <p class="font-semibold mb-6">Pengajuan Surat Keterangan Domisili Usaha di Kelurahan</p>

        <div class="mb-2">
            <h2 class="text-xl font-semibold mb-2">Deskripsi Surat</h2>
            <p class="font-semibold">Surat Keterangan Domisili adalah dokumen resmi yang dikeluarkan oleh kelurahan setempat yang menyatakan bahwa suatu usaha atau badan usaha memiliki domisili atau alamat tetap di lokasi tertentu.</p>
        </div>
    </div>
</div>
...
<div class="px-4 md:px-8 py-6 max-w-4xl mx-auto text-[#0A142F]">
    ...
    <div>
        ...
        <ol class="font-semibold space-y-3">
            @php
                $steps = [
                    'Pemohon datang ke kantor kelurahan dan menyampaikan permohonan untuk mengurus Surat Keterangan Domisili Usaha.',
                    'Menyerahkan dokumen persyaratan kepada staf kelurahan.',
                    'Staf kelurahan memeriksa kelengkapan dokumen.',
                    'Jika persyaratan telah lengkap, surat domisili usaha diproses.',
                    'Surat ditandatangani oleh pejabat kelurahan.',
                    'Surat diserahkan kepada pemohon untuk keperluan administrasi usaha.',
                ];
            @endphp
